...
def start_game():
    ...
    time.sleep(1)
    print("As Alex ventured through the Enchanted Grove, they encountered a mischievous fairy named Luna. Luna presented a riddle that guarded the path to the treasure.")
    time.sleep(1)
